...
# 1. Crear Program.cs si no existe
echo "1. Creando Program.cs..."
...
app.Run();
PROGRAM_EOF
    echo "   ✅ Program.cs creado"
else
    echo "   ✅ Program.cs ya existe"
fi

# 2. Agregar appsettings.json
echo "2. Creando appsettings.json..."
cat > appsettings.json << 'SETTINGS_EOF'
{
  "Logging": {
    "LogLevel": {
      "Default": "Information",
  ...
  "AllowedHosts": "*",
  "ConnectionStrings": {
    "DefaultConnection": "Data Source=../../talentoplus.db"
  },
  "Jwt": {
    "Key": "super_secret_key_32_chars_long_123456",
    "Issuer": "TalentoPlus",
